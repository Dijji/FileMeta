//Copied from Windows API Code Pack 1.1 and modified, mainly to give public access to PropertyVariant and fix the VT_BOOL read bug
            ...
            get
            {
                switch ((VarEnum)_valueType)
                {
                    ...
                    case VarEnum.VT_BOOL:
                        // This was a bug - VT_BOOL is a 16-bit value, 
                        // see http://msdn.microsoft.com/en-us/library/cc235117.aspx
                        // Not a problem on write, as it gets truncated, but fails on read
                        //return _int32 == -1;
                        return _short == -1;
