...
class Arg
{
	private:
		 ...
		 * value.
		 */
		static TCHAR& delimiterRef() { static TCHAR delim = ' '; return delim; }
	...
	public:
		 ...
		 */
		static TCHAR blankChar() { return (TCHAR)7; }
...
#endif
		static TCHAR flagStartChar() { return TCLAP_FLAGSTARTCHAR; }
...
#define TCLAP_NAMESTARTSTRING L"--"
		 ...
		 */
		static void setDelimiter( TCHAR c ) { delimiterRef() = c; }
