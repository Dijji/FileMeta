...
inline void StdOutput::version(CmdLineInterface& _cmd) 
{
	...
	std::wcout << std::endl << progName << "  version: " 
			  << xversion << std::endl << std::endl;
}

inline void StdOutput::usage(CmdLineInterface& _cmd ) 
{
	std::wcout << std::endl << "USAGE: " << std::endl << std::endl; 

	_shortUsage( _cmd, std::wcout );

	std::wcout << std::endl << std::endl << "Where: " << std::endl << std::endl;
								...
								ArgException& e ) 
{
	...
	std::wcerr << "PARSE ERROR: " << e.argId() << std::endl
		      << "             " << e.error() << std::endl << std::endl;

	if ( _cmd.hasHelpAndVersion() )
		{
			std::wcerr << "Brief USAGE: " << std::endl;

			_shortUsage( _cmd, std::wcerr );	

			std::wcerr << std::endl << "For complete USAGE and HELP type: " 
